...
class ChatRcvAdapter(chatList: ArrayList<Chat>) :
    ...
    override fun onBindViewHolder(viewHolder: RecyclerView.ViewHolder, position: Int) {
        if (viewHolder is CenterViewHolder) {
            viewHolder.textv.setText(chatList[position].content)
        } else if (viewHolder is LeftViewHolder) {
            viewHolder.textv_nicname.setText(chatList[position].name)
            viewHolder.textv_msg.setText(chatList[position].content)
        } else {
            (viewHolder as RightViewHolder).textv_msg.setText(chatList[position].content)
        }
    }
